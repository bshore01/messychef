            ...
            $(this)["bind"]("click", function(evt) {
                ...
                switch (social["type"]) {
                    case "facebook":
                        ...
                        break;;
                    case "twitter":
                        url = "http://twitter.com/share?url=" + socialURL + "\x26text=" + socialText;
                        break;;
                    case "plusone":
                        url = "https://plusone.google.com/_/+1/confirm?hl=en\x26url=" + socialURL;
                        break;;
                    case "pinterest":
                        url = "http://pinterest.com/pin/create/button/?url=" + socialURL + "\x26media=" + socialImage + "\x26description=" + socialText;
                        break;;
                };
...
$(document).ready(function(){
  var search_term = getParameterByName("searchterm");
  // if does not match search hide
});
...
$(document).ready(function(){
  $("#search-recipe").click(function(){
    var recipe_type = $("#search-recipe-input").val(); 
    window.location.href = "/recipes?searchterm=" +  recipe_type;
  });
});
(function() {
