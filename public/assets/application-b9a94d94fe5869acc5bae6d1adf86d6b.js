...
function addDirection() {
  var numDirections = $("#add_directions > div").length;
  
  $("#add_directions").append(
    '<div id="direction-'+numDirections+'">'+
      '<button class="delete_this_direction">x</button>'+
      '<input type="text" name="recipe[directions]['+numDirections+'][description]" value="">'+
    '</div>'
    );
}
;
...
function ingredientList(numIngredients){
  var ingredient_list = '<select class="ingredient_name" name="recipe[recipe_ingredient_units]['+numIngredients+'][ingredient_id]">'+
        ...
        ''+
          '<option value="6">Baking_powder</option>'+
        ''+
          '<option value="7">Milk</option>'+
        ''+
          '<option value="8">Chicken</option>'+
        ''+
          '<option value="9">Oil</option>'+
        ''+
          '<option value="10">Crumbled_bread</option>'+
        ''+
        ...
        ''+
        '<option value="14">New ingredient</option>'+
      '</select>';
...
function unitList(numIngredients){
  var unit_list = '<select  class="unit_name" name="recipe[recipe_ingredient_units]['+numIngredients+'][unit_id]">'+
        ...
        ''+
          '<option value="4">Table spoon</option>'+
        ''+
          '<option value="5">Tea spoon</option>'+
        ''+
...
//                 var b, c, d;
//                 //what even it is, if its a function, this .onresult gives the intent, the stats, etc.
