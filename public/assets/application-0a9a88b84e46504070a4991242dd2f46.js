...
function addIngredient(riuId){
  ...
  $("#add_ingredients")
      ...
      .append(
        ...
        '<input type="number" name="recipe[recipe_ingredient_units]['+riuId+'][amount]">'+

        '<select id="select_unit" data-placeholder="- Add unit of measurement -" name="recipe[recipe_ingredient_units]['+riuId+'][unit_id]">'+
          '<option></option>'+
          ''+
